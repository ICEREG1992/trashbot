        ...
        if (message.content.startswith("!feed")):
            if (t > dt.datetime.now() - dt.timedelta(hours=6)):
                ...
                await message.channel.send(pick_string([
                    ...
                    "about time i got some " + (message.content[message.content.index(' '):] if len(message.content) > 6 else "seeds") + " in here ive been sooooooooooooooooooooooooooooo hungry",
