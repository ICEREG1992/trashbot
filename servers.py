    ...
    async def run(self, message):
        ...
        # minecraft
            ...
            if not servers.serverExists():
                ...
                server = subprocess.Popen(['java','-Xms1G','-Xmx1G','-jar','server.jar','nogui'], cwd=r'/home/william/minecraft/', stdin=subprocess.PIPE)
        ...
        # sven coop
            ...
            if not servers.serverExists():
                ...
                server = subprocess.Popen(['bash','svends_run', '+maxplayers', '32'], cwd=r'/home/william/steam/', stdin=subprocess.PIPE)
                helperfunctions.bot_wait_long()
                await message.channel.send(helperfunctions.pick_string([
                    "ok im runnin",
                    "epic sven",
