...
set CLASSPATH=%APP_HOME%\lib\trashbot.jar;%APP_HOME%\lib\helpList.dat;%APP_HOME%\lib\emojisReactionData.dat;%APP_HOME%\lib\instantHumorContainsPhrases.dat;%APP_HOME%\lib\lyrics.dat;%APP_HOME%\lib\speakList.dat;%APP_HOME%\lib\instantHumorEqualsPhrases.dat;%APP_HOME%\lib\permissions.dat;%APP_HOME%\lib\todoList.dat;%APP_HOME%\lib\data;%APP_HOME%\lib\javacord-core-3.0.0.jar;%APP_HOME%\lib\javacord-api-3.0.0.jar;%APP_HOME%\lib\logging-interceptor-3.9.1.jar;%APP_HOME%\lib\okhttp-3.9.1.jar;%APP_HOME%\lib\jackson-databind-2.9.3.jar;%APP_HOME%\lib\nv-websocket-client-1.31.jar;%APP_HOME%\lib\log4j-api-2.11.0.jar;%APP_HOME%\lib\okio-1.13.0.jar;%APP_HOME%\lib\jackson-annotations-2.9.0.jar;%APP_HOME%\lib\jackson-core-2.9.3.jar
